const en = {
  ...
  dialogs: {
    ...
    connectingToDevice: 'Talking to la machine - bip bip..',
  ...
  deviceInfo: {
    ...
    nvs: {
      ...
      flashStatusFlashingTotal: 'Flashing {label} - {written} of {total} bytes at {baud}',
      flashStatusFinalizing: 'Finalizing flash...',
      flashComplete: 'Flashed {label} in {seconds}s.',
