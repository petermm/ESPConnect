const zh = {
  ...
  disconnected: {
    ...
    laMachineActionHint: '像真正的机器一样，它喜欢躲在技术名号下（比如 USB/JTAG）。如果它在玩躲猫猫，试试先拔掉再重新插上，然后轻轻“挠挠”它的按钮。',
  ...
  deviceInfo: {
    ...
    nvs: {
      ...
      flashStatusFlashingTotal: '正在刷写 {label} - {written}/{total} 字节（{baud}）',
      flashStatusFinalizing: '正在完成刷写…',
      flashComplete: '{label} 刷写完成，用时 {seconds}s。',
